...
def pansharpenIHS(hiri_input, cas_input, outputName="outputIHS.tif", band1=1, band2=2, band3=3):
    ...
    # Detail image P - I
    detail_Image = np.subtract(rasterArrayHiri, intensity_image, dtype=np.float32)
...
if __name__ == '__main__':
    ...
    pansharpenIHS(PAN_input, MS_input, outputname, band1, band2, band3)
