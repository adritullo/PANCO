...
def PansharpenNormHPF(hiri_input, cas_input, outputName = "outputNormHPF.tif", band1=1, band2=2, band3=3):
    ...
    detail_Image = np.subtract(normalized_PAN, lowPassArrayHiRI, dtype=np.float32)
...
if __name__ == '__main__':
    ...
    PansharpenNormHPF(PAN_input, MS_input, outputname, band1, band2, band3)
